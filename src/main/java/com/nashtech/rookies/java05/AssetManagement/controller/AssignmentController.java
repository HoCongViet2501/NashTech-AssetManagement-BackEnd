...
public class AssignmentController {
	...
	AssignmentResponse createAssignment(@PathVariable String assignedby,@Valid @RequestBody AssignmentRequest assignmentRequest) {
	...
	@GetMapping("/search/{location}/{content}")
	  public List<AssignmentDetailResponse> searchAssignment(@PathVariable String location,@PathVariable String content) {
